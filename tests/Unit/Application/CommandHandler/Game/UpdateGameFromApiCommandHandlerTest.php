...
it(
    'successfully updates game when publisher and developer need to be created',
    function () {
        // Given
        $this->game
            ->expects($this->once())
        ...
        $createPublisherEnvelope = new Envelope(
            new CreatePublisherCommand(
                $this->publisherDto->name,
                $this->publisherDto->website,
                $this->publisherDto->apiId,
            ),
        ...
        $createDeveloperEnvelope = new Envelope(
            new CreateDeveloperCommand(
                $this->developerDto->name,
                $this->developerDto->website,
                $this->developerDto->apiId,
            ),
            [new HandledStamp(true, 'handler.service_id')],
        );
...
it(
    'successfully updates game when publisher and developer need to be updated',
    function () {
        // Given
        $this->game
            ->expects($this->once())
...
it(
    'successfully updates game when apiGame has null publisher and developer',
    function () {
        // Given
        ...
        $command = new UpdateGameFromApiCommand(
            $this->game,
            $apiGameWithNullCompanies,
        );
...
it(
    'throws CannotCreatePublisherException when publisher creation fails',
    function () {
        // Given
        $this->game
            ->expects($this->once())
...
it(
    'throws CannotUpdatePublisherException when publisher update fails',
    function () {
        // Given
        $this->game
            ->expects($this->once())
...
it(
    'throws CannotCreateDeveloperException when developer creation fails',
    function () {
        // Given
        $this->game
            ->expects($this->once())
...
it(
    'throws CannotUpdateDeveloperException when developer update fails',
    function () {
        // Given
        $this->game
            ->expects($this->once())
...
it(
    'throws CannotUpdateGameException when game repository update fails',
    function () {
        // Given
        $apiGameWithNullCompanies = new ApiGame(
            name: $this->faker->words(3, true),
...
it(
    'handles different types of exceptions during game repository update',
    function () {
        // Given
        $apiGameWithNullCompanies = new ApiGame(
            name: $this->faker->words(3, true),
...
it(
    'handles mixed scenarios with publisher creation and developer update',
    function () {
        // Given
        $this->game
            ->expects($this->once())
